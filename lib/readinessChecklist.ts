...
export const OFFICIAL_READINESS_ITEMS: ReadinessChecklistItem[] = [
  ...
  item("rb_main_manual_bp", "red_bag", "Red Bag", "Main Compartment", "Manual blood pressure cuff", { critical: true, manualVerify: true, minQty: 1 }),
  item("rb_main_opa", "red_bag", "Red Bag", "Main Compartment", "OPA 6.0-10.0 mm, one for each size", { critical: true, manualVerify: true, minQty: 1 }),
  item("rb_main_npa", "red_bag", "Red Bag", "Main Compartment", "NPA 4.0-8.0 mm, one for each size", { minQty: 1 }),
  item("rb_main_thermometer", "red_bag", "Red Bag", "Main Compartment", "Thermometer", { minQty: 1 }),
  ...
  item("rb_main_blanket", "red_bag", "Red Bag", "Main Compartment", "Emergency blanket", { minQty: 1 }),
  item("rb_main_plastic_bandage", "red_bag", "Red Bag", "Main Compartment", "Plastic bandage", { minQty: 1 }),
  item("rb_front_alcohol_swab", "red_bag", "Red Bag", "Frontal Compartment", "Alcohol swab 100 pcs box", { minQty: 1 }),
  item("rb_front_iv_set", "red_bag", "Red Bag", "Frontal Compartment", "IV set", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_tourniquet", "red_bag", "Red Bag", "Frontal Compartment", "Tourniquet", { minQty: 1, serviceLevels: ["ACLS"] }),
  item("rb_front_iv_dressing", "red_bag", "Red Bag", "Frontal Compartment", "IV dressing", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_stopcock", "red_bag", "Red Bag", "Frontal Compartment", "3-way stopcock", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_cannula_14", "red_bag", "Red Bag", "Frontal Compartment", "IV cannula G14", { minQty: 2, serviceLevels: ["ACLS"] }),
  item("rb_front_cannula_16", "red_bag", "Red Bag", "Frontal Compartment", "IV cannula G16", { minQty: 2, serviceLevels: ["ACLS"] }),
  item("rb_front_cannula_18", "red_bag", "Red Bag", "Frontal Compartment", "IV cannula G18", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_cannula_20", "red_bag", "Red Bag", "Frontal Compartment", "IV cannula G20", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_cannula_22", "red_bag", "Red Bag", "Frontal Compartment", "IV cannula G22", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_cannula_24", "red_bag", "Red Bag", "Frontal Compartment", "IV cannula G24", { minQty: 3, serviceLevels: ["ACLS"] }),
  item("rb_front_syringe_3", "red_bag", "Red Bag", "Frontal Compartment", "3 cc syringe", { minQty: 3 }),
  item("rb_front_syringe_5", "red_bag", "Red Bag", "Frontal Compartment", "5 cc syringe", { minQty: 3 }),
  item("rb_front_syringe_10", "red_bag", "Red Bag", "Frontal Compartment", "10 cc syringe", { minQty: 3 }),
